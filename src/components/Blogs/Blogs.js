        ...
        <div>
            ...
            <div className='second-blog'>
                <p>
                    ...
                    <h6>The semantic HTML tags help the search engines and other user devices to determine the importance and context of web pages.</h6>
                    <h6>The pages made with semantic elements are much easier to read.</h6>
                    <h6>It has greater accessibility. It offers a better user experience.</h6>
